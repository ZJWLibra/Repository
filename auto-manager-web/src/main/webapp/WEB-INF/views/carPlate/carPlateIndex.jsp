...
<body class="gray-bg">
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                       	<form class="form-inline">
                        	...
                        	<input type="text" placeholder="请输入车牌名称" class="form-control" id="selectPlateName" />
							<label class="control-label">状态:</label>
                        	<select class="form-control m-b" style="width:100px;margin-top:15px" id="selectPlateStatus">
						...
						<div class="form-group">
							...
							<button data-toggle="button" class="btn btn-primary carPlate-update" type="button">修改</button>
						</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="m-t-none m-b">新增车牌</h3>
                            <form role="form" id="insertForm">
                                <div class="form-group">
                                    <label class="must-label">车牌名称(必填):</label>
                                    <input type="text" placeholder="请输入颜色名称" class="form-control" id="plateName" name="plateName" />
                                </div>
                                <div class="form-group">
                                    <label>车牌描述:</label>
                        			<textarea id="plateDes" name="plateDes" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>状态:</label>
                                    <select class="form-control m-b" id="plateStatus" name="plateStatus">
										<option value="Y">启用</option>
										<option value="N">禁用</option>
									</select>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="m-t-none m-b">编辑车牌</h3>
                            <form role="form" id="editForm">
                            	<input type="hidden" id="editPlateId" name="plateId" />
								<div class="form-group">
                                    <label class="must-label">车牌名称(必填):</label>
                                    <input type="text" placeholder="请输入车牌名称" class="form-control" id="editPlateName" name="plateName" />
                                </div>
                                <div class="form-group">
                                    <label>车牌描述:</label>
                        			<textarea id="editPlateDes" name="plateDes" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>状态:</label>
                                    <select class="form-control m-b" id="editPlateStatus" name="plateStatus">
										<option value="Y">启用</option>
										<option value="N">禁用</option>
									</select>
                                </div>
    ...
    <script type="text/javascript" src="js/carPlate/carPlate.js"></script>
    <script type="text/javascript" src="js/carPlate/carPlate.validate.js"></script>
</body>
</html>
